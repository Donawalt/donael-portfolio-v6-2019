      ...
      <Layout>
        <section className="aboutSection">
          ...
          <article className="article">
            ...
            <p className="intro">
              Front-end Developer and UI/UX Designer in Paris. I work at <a href="https://opsone.net" target="_blank">OPSONE</a> as a Junior Web Designer. I study at <a href="https://www.hetic.net" target="_blank">HÉTIC</a> in Web development and Webdesign. I'm also available in freelancing.
            </p>
